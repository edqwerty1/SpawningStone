(function() {
  ...
  function spellService($resource, $http) {
    ...
    this.getSpells2 = getSpells2;
    this.getSpells3 = getSpells3;
    this.getSpells4 = getSpells4;
    ...
    function getSpells() {
      var resource = $resource(
        "http://spawningstone.cloudapp.net/Spells.svc/?",
        {
      ...
      return resource.getSpells().$promise;
    }
    ...
    function getSpells3(){
        ...
        var request = 'http://spawningstone.cloudapp.net/Spells.svc/';
        var config = {
          'params': {
            'callback': 'JSON_CALLBACK'
          }
        };
        return $http.jsonp(request, config);
    }
